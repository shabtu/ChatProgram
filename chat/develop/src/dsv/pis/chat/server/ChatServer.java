    ...
    Runnable			// for the distribution thread.
{
   ...
   *
*/
    public synchronized ArrayList returnClientList() {
     return users;
    }
    ...
    throws java.rmi.RemoteException
  {
    ...
    @Override
    public void addToClientList(String name) throws RemoteException {
    users.add(name);
    }
  ...
  public void readLoop () {
	...
	System.out.println ("help      This text.");
          System.out.println("HELWSHLWEOHWEOHEOWHOEWJ");
      }
      else {
