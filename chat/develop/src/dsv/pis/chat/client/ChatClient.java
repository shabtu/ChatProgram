    ...
    RemoteEventListener		// So we can receive chat notifications
{
   ...
   */
  public int connectToChat (String serverNamePattern) throws RemoteException {
	...
	if (accept) {
	  ...
	  if (newServer != null) {
	    ...
	    myServer = newServer;
	    myServer.addToClientList(myName);
	    return i;
	  }
	}
      }
  ...
  public void readLoop () throws RemoteException {
    ...
    private void getUsers() throws RemoteException {
        ArrayList<String> users = myServer.returnClientList();
